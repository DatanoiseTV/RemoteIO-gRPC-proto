...
type InterruptMessage_Edge int32

const (
	InterruptMessage_RISING_EDGE  InterruptMessage_Edge = 0
	InterruptMessage_FALLING_EDGE InterruptMessage_Edge = 1
	InterruptMessage_BOTH_EDGE    InterruptMessage_Edge = 2
)

// Enum value maps for InterruptMessage_Edge.
var (
	InterruptMessage_Edge_name = map[int32]string{
		0: "RISING_EDGE",
		1: "FALLING_EDGE",
		2: "BOTH_EDGE",
	}
	InterruptMessage_Edge_value = map[string]int32{
		"RISING_EDGE":  0,
		"FALLING_EDGE": 1,
		"BOTH_EDGE":    2,
	}
...
func (x InterruptMessage_Edge) Enum() *InterruptMessage_Edge {
	p := new(InterruptMessage_Edge)
	*p = x
	return p
}

func (x InterruptMessage_Edge) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (InterruptMessage_Edge) Descriptor() protoreflect.EnumDescriptor {
	return file_remoteio_proto_enumTypes[1].Descriptor()
}

func (InterruptMessage_Edge) Type() protoreflect.EnumType {
	return &file_remoteio_proto_enumTypes[1]
}

func (x InterruptMessage_Edge) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Use InterruptMessage_Edge.Descriptor instead.
func (InterruptMessage_Edge) EnumDescriptor() ([]byte, []int) {
	return file_remoteio_proto_rawDescGZIP(), []int{5, 0}
}
...
type InterruptMessage struct {
	...
	Pin         uint32                `protobuf:"varint,1,opt,name=pin,proto3" json:"pin,omitempty"`
	TriggerType InterruptMessage_Edge `protobuf:"varint,2,opt,name=triggerType,proto3,enum=remoteio.InterruptMessage_Edge" json:"triggerType,omitempty"`
}

func (x *InterruptMessage) Reset() {
	*x = InterruptMessage{}
	if protoimpl.UnsafeEnabled {
		mi := &file_remoteio_proto_msgTypes[5]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}

func (x *InterruptMessage) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*InterruptMessage) ProtoMessage() {}

func (x *InterruptMessage) ProtoReflect() protoreflect.Message {
	mi := &file_remoteio_proto_msgTypes[5]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use InterruptMessage.ProtoReflect.Descriptor instead.
func (*InterruptMessage) Descriptor() ([]byte, []int) {
	return file_remoteio_proto_rawDescGZIP(), []int{5}
}

func (x *InterruptMessage) GetPin() uint32 {
	if x != nil {
		return x.Pin
	}
	return 0
...
func (x *InterruptMessage) GetTriggerType() InterruptMessage_Edge {
	if x != nil {
		return x.TriggerType
	}
	return InterruptMessage_RISING_EDGE
}
...
var file_remoteio_proto_rawDesc = []byte{
	...
	,
	...
	,
...
var file_remoteio_proto_enumTypes = make([]protoimpl.EnumInfo, 2)
var file_remoteio_proto_msgTypes = make([]protoimpl.MessageInfo, 6)
var file_remoteio_proto_goTypes = []interface{}{
	(PinModeMessage_PortType)(0), // 0: remoteio.PinModeMessage.PortType
	(InterruptMessage_Edge)(0),   // 1: remoteio.InterruptMessage.Edge
	(*DigitalState)(nil),         // 2: remoteio.DigitalState
	(*AnalogState)(nil),          // 3: remoteio.AnalogState
	(*PinModeMessage)(nil),       // 4: remoteio.PinModeMessage
	(*SPIMessage)(nil),           // 5: remoteio.SPIMessage
	(*I2CMessage)(nil),           // 6: remoteio.I2CMessage
	(*InterruptMessage)(nil),     // 7: remoteio.InterruptMessage
	(*timestamp.Timestamp)(nil),  // 8: google.protobuf.Timestamp
}
var file_remoteio_proto_depIdxs = []int32{
	8,  // 0: remoteio.DigitalState.Timestamp:type_name -> google.protobuf.Timestamp
	8,  // 1: remoteio.AnalogState.Timestamp:type_name -> google.protobuf.Timestamp
	0,  // 2: remoteio.PinModeMessage.mode:type_name -> remoteio.PinModeMessage.PortType
	8,  // 3: remoteio.PinModeMessage.Timestamp:type_name -> google.protobuf.Timestamp
	8,  // 4: remoteio.SPIMessage.Timestamp:type_name -> google.protobuf.Timestamp
	8,  // 5: remoteio.I2CMessage.Timestamp:type_name -> google.protobuf.Timestamp
	1,  // 6: remoteio.InterruptMessage.triggerType:type_name -> remoteio.InterruptMessage.Edge
	4,  // 7: remoteio.RemoteIO.pinMode:input_type -> remoteio.PinModeMessage
	2,  // 8: remoteio.RemoteIO.digitalRead:input_type -> remoteio.DigitalState
	2,  // 9: remoteio.RemoteIO.digitalWrite:input_type -> remoteio.DigitalState
	3,  // 10: remoteio.RemoteIO.analogRead:input_type -> remoteio.AnalogState
	3,  // 11: remoteio.RemoteIO.analogWrite:input_type -> remoteio.AnalogState
	5,  // 12: remoteio.RemoteIO.spiRead:input_type -> remoteio.SPIMessage
	5,  // 13: remoteio.RemoteIO.spiWrite:input_type -> remoteio.SPIMessage
	6,  // 14: remoteio.RemoteIO.i2cRead:input_type -> remoteio.I2CMessage
	6,  // 15: remoteio.RemoteIO.i2cWrite:input_type -> remoteio.I2CMessage
	7,  // 16: remoteio.RemoteIO.subscribeInterrupt:input_type -> remoteio.InterruptMessage
	4,  // 17: remoteio.RemoteIO.pinMode:output_type -> remoteio.PinModeMessage
	2,  // 18: remoteio.RemoteIO.digitalRead:output_type -> remoteio.DigitalState
	2,  // 19: remoteio.RemoteIO.digitalWrite:output_type -> remoteio.DigitalState
	3,  // 20: remoteio.RemoteIO.analogRead:output_type -> remoteio.AnalogState
	3,  // 21: remoteio.RemoteIO.analogWrite:output_type -> remoteio.AnalogState
	5,  // 22: remoteio.RemoteIO.spiRead:output_type -> remoteio.SPIMessage
	5,  // 23: remoteio.RemoteIO.spiWrite:output_type -> remoteio.SPIMessage
	6,  // 24: remoteio.RemoteIO.i2cRead:output_type -> remoteio.I2CMessage
	6,  // 25: remoteio.RemoteIO.i2cWrite:output_type -> remoteio.I2CMessage
	2,  // 26: remoteio.RemoteIO.subscribeInterrupt:output_type -> remoteio.DigitalState
...
func file_remoteio_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_remoteio_proto_msgTypes[5].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*InterruptMessage); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
...
type RemoteIOClient interface {
	...
	SubscribeInterrupt(ctx context.Context, in *InterruptMessage, opts ...grpc.CallOption) (RemoteIO_SubscribeInterruptClient, error)
}
...
func (c *remoteIOClient) SubscribeInterrupt(ctx context.Context, in *InterruptMessage, opts ...grpc.CallOption) (RemoteIO_SubscribeInterruptClient, error) {
	stream, err := c.cc.NewStream(ctx, &_RemoteIO_serviceDesc.Streams[0], "/remoteio.RemoteIO/subscribeInterrupt", opts...)
	if err != nil {
		return nil, err
	}
	x := &remoteIOSubscribeInterruptClient{stream}
...
type RemoteIO_SubscribeInterruptClient interface {
	Recv() (*DigitalState, error)
	grpc.ClientStream
}

type remoteIOSubscribeInterruptClient struct {
	grpc.ClientStream
}

func (x *remoteIOSubscribeInterruptClient) Recv() (*DigitalState, error) {
	m := new(DigitalState)
...
type RemoteIOServer interface {
	...
	SubscribeInterrupt(*InterruptMessage, RemoteIO_SubscribeInterruptServer) error
}
...
func (*UnimplementedRemoteIOServer) SubscribeInterrupt(*InterruptMessage, RemoteIO_SubscribeInterruptServer) error {
	return status.Errorf(codes.Unimplemented, "method SubscribeInterrupt not implemented")
}
...
func _RemoteIO_SubscribeInterrupt_Handler(srv interface{}, stream grpc.ServerStream) error {
	m := new(InterruptMessage)
	if err := stream.RecvMsg(m); err != nil {
		return err
	}
	return srv.(RemoteIOServer).SubscribeInterrupt(m, &remoteIOSubscribeInterruptServer{stream})
}

type RemoteIO_SubscribeInterruptServer interface {
	Send(*DigitalState) error
	grpc.ServerStream
}

type remoteIOSubscribeInterruptServer struct {
	grpc.ServerStream
}

func (x *remoteIOSubscribeInterruptServer) Send(m *DigitalState) error {
...
var _RemoteIO_serviceDesc = grpc.ServiceDesc{
	...
	Streams: []grpc.StreamDesc{
		{
			StreamName:    "subscribeInterrupt",
			Handler:       _RemoteIO_SubscribeInterrupt_Handler,
			ServerStreams: true,
		},
	},
